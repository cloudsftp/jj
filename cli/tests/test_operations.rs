...
fn test_op_diff() {
    ...
    From operation: 869a48b9de32 (2001-02-03 08:05:37) delete bookmark bookmark-2
      To operation: 94caadd7872d (2001-02-03 08:05:39) push all tracked bookmarks/tags to git remote origin
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: 94caadd7872d (2001-02-03 08:05:39) push all tracked bookmarks/tags to git remote origin
      To operation: 2ee615c3550f (2001-02-03 08:05:41) set tag tag1 to commit 96f3a57c9a4a4ae7bb45d1eafe32fe3b6e33f458
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: 2ee615c3550f (2001-02-03 08:05:41) set tag tag1 to commit 96f3a57c9a4a4ae7bb45d1eafe32fe3b6e33f458
      To operation: 53d5e793dc90 (2001-02-03 08:05:45) delete tag tag1
...
fn test_op_show() {
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    51917226eaa7 test-username@host.example.com default@ 2001-02-03 04:05:33.000 +07:00 - 2001-02-03 04:05:33.000 +07:00
